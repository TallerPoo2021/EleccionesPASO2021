...
public class Admin {
    ...
    public static List<ListaPolitica> generaListas() {
        ...
        Distrito corrientes = new Distrito(3, 3, "Corrientes", null, listListasPoliticas = new ArrayList<>());
        /*
        ...
        senCorrienteAccionCorriente.add(new Candidato("Jorge Americo", "Parthimos", TipoCandidato.SENADOR));
        senCorrienteAccionCorriente.add(new Candidato("Mirta Teresa", "Toffaleti", TipoCandidato.SENADOR));
        ...
        senCorrienteFrenteDeTodos.add(new Candidato("Nieve de los Angeles", "Cuenca", TipoCandidato.SENADOR));

        // Diputados
        List<Candidato> dipuCorrientesAccionCorriente = new ArrayList<Candidato>();

        dipuCorrientesAccionCorriente.add(new Candidato("Anibal Daniel", "Godoy", TipoCandidato.DIPUTADO));
        dipuCorrientesAccionCorriente.add(new Candidato("Leticia Maria", "Caminos", TipoCandidato.DIPUTADO));
        dipuCorrientesAccionCorriente.add(new Candidato("Jose Fernando", "Novello", TipoCandidato.DIPUTADO));

        List<Candidato> dipuCorrientesfrenteDeTodos = new ArrayList<Candidato>();
        dipuCorrientesfrenteDeTodos.add(new Candidato("Jorge Gustavo", "Silva", TipoCandidato.DIPUTADO));
        dipuCorrientesfrenteDeTodos.add(new Candidato("Lilian", "Caruso", TipoCandidato.DIPUTADO));
        dipuCorrientesfrenteDeTodos.add(new Candidato("Alfredo Alejandro", "Moline", TipoCandidato.DIPUTADO));
